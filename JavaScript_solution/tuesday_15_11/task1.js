...
// create table in js
        ...
        let table1 = '<table>';
        table1 += '<tr><th>ID</th><th>firstName</th><th>lastName</th><th>maidenName</th><th>age</th></tr>';
        x.map( (ele) => {
            var Id = ele.id;
            var fName = ele.firstName;
            var lName = ele.lastName;
            var mName = ele.maidenName;
            var age = ele.age;
            table1 = table1 + '<tr>',
            table1 = table1 + '<td>'+ `${Id}` + '</td>',
            table1 = table1 + '<td>' + `${fName}` + '</td>',
            table1 = table1 + '<td>' + `${lName}` + '</td>'
            table1 = table1 + '<td>'  + `${mName}` + '</td>'
            table1 = table1 + '<td>' + `${age}` + '</td>'
         });  
         table1 += "</table>"
