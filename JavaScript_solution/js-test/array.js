...
// let myFriends = [`ahmed`,`mohammad`,`sayed`,[`marwan`,`ali`]]
...
// let x = myFriends.shift();
// console.log(myFriends)
// console.log(x);
// console.log(myFriends.includes("mohammad"));
...
console.log(my.reverse().slice(zero)); // ["Osama", "Elham", "Mazero", "Ahmed"];
console.log(my); 
console.log(my.pop().slice(counter)); // ["Elham", "Mazero"]

console.log(`${my.reverse()[3]}${`zero`}}`); // "Elzero"

console.log(my.sort()); // "rO"